  ...
  return (
    <div className="bg-slate-900 min-h-screen flex flex-col pb-16">
      ...
      <div className="flex-grow pt-8 px-4 md:px-16 lg:px-32">
        <h1 className="text-4xl text-white text-center mb-16">Contact Me</h1>
        <TextCard hoverZoom={true} className="mx-auto max-w-3xl mb-8 bg-slate-800 border-2 border-blue-500 hover:shadow-[0_10px_40px_rgba(59,130,246,0.7)]">
