...
const Sujet3: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900 min-h-screen flex flex-col pb-16">
      <Navbar />
      <BlogCard content="3. Découverte du CMS" className="mt-6" />
      <div className="flex-grow pt-8 px-4 md:px-16 lg:px-32">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-2xl font-bold text-white mb-8 text-center md:text-left">Découverte de l'outil</h1>
          <div className="mb-16 text-left">
            ...
            <img src="/images/wordpress/logo.png" alt="Logo WordPress" className="mx-auto w-full md:w-2/3 lg:w-1/2 h-auto object-cover mb-4"/>
            <p className="text-slate-300 text-lg mb-4">
          ...
          <div className="mb-16 text-left">
            ...
            <img src="/images/wordpress/extentions.png" alt="Tableau de bord WordPress" className="mx-auto w-full md:w-2/3 lg:w-1/2 h-auto object-cover rounded-lg shadow-lg mb-4"/>
            <p className="text-slate-300 text-lg mb-4">
          ...
          <div className="mb-16 text-left">
            ...
            <img src="/images/wordpress/horrible.png" alt="Site WordPress" className="mx-auto w-full md:w-2/3 lg:w-1/2 h-auto object-cover rounded-lg shadow-lg mb-4"/>
          </div>
          <p className="text-slate-300 text-lg mb-4">
