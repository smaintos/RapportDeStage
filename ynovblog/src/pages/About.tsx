...
const About: React.FC = () => {
  return (
    <div className="bg-slate-900 min-h-screen flex flex-col pb-[4rem]">
      <Navbar />
            <div className="w-full h-[20rem] mt-[2rem]">
        <img 
      ...
      <div className="flex-grow pt-[2rem] px-[4rem]">
        <div className="mt-[4rem]">
          <TextCard hoverZoom={true} className="relative z-10 bg-slate-800 border-2 border-blue-500 hover:shadow-[0_10px_40px_rgba(59,130,246,0.7)]">
            <h1 className="text-5xl text-white font-light text-center">Présentation de l'Association Nouvelle Voix</h1>
            <br />
          ...
          <div className="mt-[4rem] grid grid-cols-1 md:grid-cols-2 gap-8">
            <img src="/images/association_1.jpg" alt="Talent artistique en performance" className="w-full h-[30rem] object-cover rounded-lg shadow-lg transform hover:translate-y-[-10px] transition-transform duration-300" loading="lazy"/>
            <img src="/images/association_2.jpg" alt="Projet en cours chez Nouvelle Voix" className="w-full h-[30rem] object-cover rounded-lg shadow-lg transform hover:translate-y-[-10px] transition-transform duration-300" loading="lazy" />
          </div>
        </div>
        <div className="mt-[6rem]">
          <TextCard hoverZoom={true} className="relative z-10 bg-slate-800 border-2 border-blue-500 hover:shadow-[0_10px_40px_rgba(59,130,246,0.7)]">
            <h2 className="text-4xl text-slate-200 text-center">Les Ateliers de Nouvelle Voix</h2>
            <br />
            <p className="text-slate-300 text-lg">
            Nouvelle Voix organise des ateliers vraiment intéressants pour ceux qui souhaitent découvrir les métiers créatifs et artistiques. Que ce soit en photo, musique, vidéo ou création artistique, ils vous donnent l’opportunité de toucher à tout, même si vous n’y connaissez rien au départ.<br></br> 

            Ces ateliers sont proposés là où ils sont vraiment nécessaires : dans les écoles, les prisons, les centres sociaux… <br></br> Bref, là où il y a des personnes qui ont besoin d’un coup de pouce pour découvrir de nouvelles voies professionnelles. Les professionnels de l’asso, et même des experts d’autres entreprises, viennent animer les sessions. Vous avez accès à du matériel professionnel et vous apprenez les bases de chaque métier, les formations possibles, et tout ce qu’il faut savoir pour vous lancer.

            L’idée, c’est de vous permettre d’expérimenter, de voir si un de ces métiers pourrait vous plaire, et de vous ouvrir des portes vers des formations ou un emploi. <br></br> En gros, c’est une super opportunité pour explorer vos passions et peut-être en faire un véritable métier.
            </p>
          </TextCard>
          <div className="mt-[4rem] grid grid-cols-1 md:grid-cols-2 gap-8">
            <img src="/images/association_3.jpg" alt="Atelier artistique en cours" className="w-full h-[30rem] object-cover rounded-lg shadow-lg transform hover:translate-y-[-10px] transition-transform duration-300" loading="lazy"/>
            <img src="/images/association_4.jpg" alt="Participants à un atelier de Nouvelle Voix" className="w-full h-[30rem] object-cover rounded-lg shadow-lg object-right-top transform hover:translate-y-[-10px] transition-transform duration-300" loading="lazy"/>
          </div>
        </div>
        <div className="mt-[6rem]">
          <TextCard hoverZoom={true} className="relative z-10 bg-slate-800 border-2 border-blue-500 hover:shadow-[0_10px_40px_rgba(59,130,246,0.7)]">
            <h2 className="text-4xl text-slate-200 text-center">Événements Organisés par Nouvelle Voix</h2>
            <br />
            <p className="text-slate-300 text-lg">
          ...
          <div className="mt-[4rem]">
            <img src="/images/association_5.jpg" alt="Événement organisé par Nouvelle Voix" className="w-full h-[30rem] object-cover rounded-lg shadow-lg transform hover:translate-y-[-10px] transition-transform duration-300" loading="lazy"/>
          </div>
        </div>
        <div className="mt-[6rem] mb-[4rem]">
          <TextCard hoverZoom={true} className="relative z-10 bg-slate-800 border-2 border-blue-500 hover:shadow-[0_10px_40px_rgba(59,130,246,0.7)]">
            <h2 className="text-4xl text-slate-200 text-center">Objectifs et Valeurs de Nouvelle Voix</h2>
            <br />
            <p className="text-slate-300 text-lg">
